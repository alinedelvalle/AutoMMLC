...
class AlgorithmsHiperparameters:
    ...
    def add_metrics(prediction, y_test, time_execution, string_classifier):
        # example
    ...
    def toFile(dataset_name, file_name):
        ...
        str_title = 'dataset\tid_generation\tid_individual\thmm_loss\taccuracy\tjaccard_mi\tprecision\t'
